...
public class Main {
    public static void main(String[] args) {
        ...
        Person davut = new Person("Davut", "Gurlek",
                29, 8000, false, new String[]{"piano", "chess"});



        System.out.println("Salary: " + davut.salary);
        System.out.println("Is Teen: " + davut.isTeen());
        System.out.println("Hobbies: " + davut.getHobbies());
